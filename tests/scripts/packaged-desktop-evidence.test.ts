  ...
  it("requires an exact isolated-Sandbox harness manifest", () => {
    ...
    const manifest = {
      ...
      files: {
        ...
        m5M6PackagedWalkthrough: {
          path: "scripts/lib/m5-m6-packaged-walkthrough.mjs",
          sha256,
        },
        m5M6Runner: { path: "scripts/run-m5-m6-packaged-walkthrough.mjs", sha256 },
        ciMetadata: { path: "scripts/ci/ci-metadata.json", sha256 },
        ciBatchEvidence: { path: "scripts/ci/batch-export-evidence.json", sha256 },
        ciUpdateRepairEvidence: { path: "scripts/ci/update-repair-evidence.json", sha256 },
        ciBundleIdentity: { path: "scripts/ci/built-packaged-identity.json", sha256 },
