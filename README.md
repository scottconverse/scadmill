...
| C4 web/WASM | Source-build preparation may continue while Q-0023 governs whether the exact-date official prebuilt artifact can replace the mandated official-source build. | AC-4.a byte parity for F1/F2 STL and F3 SVG plus the three public examples. |
