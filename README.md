...
| M5: model history, batch export, libraries, project navigation, split editor, section view, library intelligence | **Planned** | Required by the complete product specification; not present in this beta. |
