...
| M6: printability, slicer handoff, engine manager, headless CLI, color/parts, colored 3MF, manufacturing estimates | **In progress on `main`, not in this beta** | The honest printability report and desktop slicer handoff are implemented; the remaining M6 capabilities are required before the complete-product milestone closes. |
