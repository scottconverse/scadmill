...
const HARNESS_FILES = {
  ...
  m5M6PackagedWalkthrough: "scripts/lib/m5-m6-packaged-walkthrough.mjs",
  m5M6Runner: "scripts/run-m5-m6-packaged-walkthrough.mjs",
  ciMetadata: "scripts/ci/ci-metadata.json",
  ciBatchEvidence: "scripts/ci/batch-export-evidence.json",
  ciUpdateRepairEvidence: "scripts/ci/update-repair-evidence.json",
  ciBundleIdentity: "scripts/ci/built-packaged-identity.json",
