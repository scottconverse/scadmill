...
export interface HarnessManifest {
  schemaVersion: 1;
  files: Record<"config" | "credentialProbe" | "keyboardInput" | "helper" | "m4PackagedWalkthrough" | "n2SoakConfiguration" | "n2SoakEvidence" | "n2SoakRunner" | "n2SoakVerifier" | "runner" | "sandboxBootstrap" | "sourceMetadata", {
    path: string;
    sha256: string;
  }>;
  policy: {
