...
- Accelerated, explicitly non-release N-2 diagnostics now use a duration-scaled memory sampling interval and baseline window that real packaged render cycles can satisfy; the literal one-hour release profile remains unchanged.
