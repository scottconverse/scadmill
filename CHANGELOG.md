...
- A candidate-runnable, digest-pinned GitHub workflow for building OpenSCAD WebAssembly from the exact approved official source commit, with parsed mutation-tested validation and checksummed JavaScript, WASM, and manifest outputs. The first hosted artifact remains pending.
